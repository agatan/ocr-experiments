...
def main():
    ...
    parser.add_argument('--validation_csv', default='data/processed/validation/annotations.csv')
    ...
    training_model.fit_generator(gen.batches(args.batch_size, infinite=True), epochs=args.epochs, steps_per_epoch=steps_per_epoch, validation_data=valid_gen.batches(8), validation_steps=16, callbacks=callbacks)
